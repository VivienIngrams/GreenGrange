...
// Query: *[_type == "infoSection"] | order(order asc) {    identifier,    homepageContent,    linkText,  }
export type GetInfoSectionsQueryResult = Array<never>;
// Variable: getInfoSectionByIdQuery
// Query: *[_type == "infoSection" && identifier == $identifier][0] {    identifier,    homepageContent,    pageContent,    linkText,  }

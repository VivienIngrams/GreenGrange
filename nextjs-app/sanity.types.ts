...
// Query: *[_type == "infoSection" && identifier == $identifier][0] {    title,    identifier,    homepageContent,    pageContent,    linkText,    order,    "image": {      "src": image.asset->url,      "alt": image.alt    }  }
export type GetInfoSectionByIdQueryResult = null;
// Variable: getNextInfoSectionQuery
// Query: *[_type == "infoSection" && order > $order] | order(order asc) [0] {    title,    identifier,    linkText  }
export type GetNextInfoSectionQueryResult = null;
// Variable: getFirstInfoSectionQuery
// Query: *[_type == "infoSection"] | order(order asc) [0] {    title,    identifier,    linkText  }
export type GetFirstInfoSectionQueryResult = null;

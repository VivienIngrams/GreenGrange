...
export default function HeroSection() {
  return (
    <section className="relative min-h-[85vh] flex items-center font-kalnia justify-center">
...
<div className="absolute inset-0 bg-black/15 z-0"></div>
      ...
      <div className="container mx-auto max-w-5xl text-center text-white relative z-10">
        ...
        <div className="inline-flex items-center gap-2 backdrop-blur-sm px-4 py-2 rounded-full  hover:bg-green-500/20 transition-all hover:scale-[1.02] ">
